...
You can start writing assets in `dag_scrape_project/assets/`. The assets are automatically loaded into the Dagster repository as you define them.
...
Tests are in the `dag_scrape_project_tests` directory and you can run tests using `pytest`:

```bash
pytest dag_scrape_project_tests
```
